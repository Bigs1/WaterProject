...
namespace WaterProject.Controllers
{
    ...
    public class WaterController : ControllerBase
    {
        ...
        public IActionResult GetProjects(int pageHowMany = 5, int pageNumber = 1) //goes to the database,getting how many selected projects we want to display, default value of 5
        {
